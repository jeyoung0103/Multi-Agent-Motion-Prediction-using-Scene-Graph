...
class QCNetDecoder(nn.Module):
    ...
    def forward(self, pos_m: torch.Tensor,
        ...
        m = self.mode_emb.weight.repeat(agent_num_nodes, 1)

        # New, The bug with the "agnet_num_modes" is fixed
        ...
        r_t2m = self.r_t2m_emb(continuous_inputs=r_t2m.float(), categorical_embs=None)
