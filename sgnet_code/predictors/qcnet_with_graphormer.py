"""
QCNet with Graphormer integration
"""
...
class QCNetWithGraphormer(pl.LightningModule):
    """
    QCNet with Graphormer integration for enhanced agent-agent relationship modeling
    """
    ...
    def __init__(self,
                 ...
                 graphormer_history_steps: int = 2,
                 graphormer_history_pos_eps: float = 0.5,
                 **kwargs) -> None:
        super(QCNetWithGraphormer, self).__init__()
        ...
        self.encoder = QCNetEncoderWithGraphormer(
            dataset=dataset,
            input_dim=input_dim,
            ...
            graphormer_history_pos_eps=graphormer_history_pos_eps,
        )
    ...
    def configure_optimizers(self):
        ...
        # Remove overlapping parameters from decay set
        decay = decay - inter_params
        
        # Check if all parameters are accounted for
